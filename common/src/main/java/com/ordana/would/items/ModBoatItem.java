...
public class ModBoatItem extends Item {
    ...
    public final ModBoatEntity.Type type;
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        ...
        return this.hasChest ? new ModChestBoatEntity(level, vec3.x, vec3.y, vec3.z) : new ModBoatEntity(level, vec3.x, vec3.y, vec3.z);
    }
}