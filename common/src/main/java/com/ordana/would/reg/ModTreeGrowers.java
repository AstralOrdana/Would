...
public class ModTreeGrowers {
    ...
    public static TreeGrower CEDAR = new TreeGrower("cedar", Optional.empty(), Would.createKey("cedar"), Optional.empty());

    public static TreeGrower MAHOGANY = new TreeGrower("mahogany", Optional.empty(), Would.createKey("mahogany"), Optional.empty());

    public static TreeGrower MAPLE = new TreeGrower("maple", Optional.empty(), Would.createKey("maple"), Optional.empty());

    public static TreeGrower ASPEN = new TreeGrower("aspen", Optional.empty(), Would.createKey("aspen"), Optional.empty());
